...
const Header = () => {
  const commonClasses =
    "w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600";
      ...
      <div className="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
        <div className="lg:col-span-4">
          ...
          <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">
            Repairing medical equipment requires specialized knowledge and
            expertise. Our team of skilled technicians is dedicated to providing
            fast and reliable repairs for a wide range of medical devices.
          </p>
          <Link
            href={"/products"}
